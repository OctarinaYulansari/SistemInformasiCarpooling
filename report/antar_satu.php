...
<html>
    ...
    <body onload="print()">
        ...
        $sql = "SELECT * FROM antar WHERE NIP='" . $_GET ['NIP'] . "'";
                    ...
                    <div class="text-center">
                        ...
                        <table class="table table-bordered table-striped table-hover text-left"> 
                            <tbody>
                                ...
                                <tr>
                                    <td><strong>Jam Antar</td></strong><td><?= $data['Jam_Antar'] ?></td>
                                </tr>
								<tr>
                                    <td><strong>Tujuan</strong></td> <td><?= $data['Tujuan'] ?></td>
                                </tr>
								<tr>
                                    <td><strong>Lama Perjalanan</strong></td> <td><?= $data['Lama_Perjalanan'] ?></td>
                                </tr>
								<tr>
                                    <td><strong>Keterangan</strong></td> <td><?= $data['keterangan'] ?></td>
                                </tr>
                            </tbody>
                            <tfoot> 
                                <tr>
